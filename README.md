...
Fleasion is available for **Windows and Linux**.
...
The config also works with **Fleasion + Sober** on Linux.

The Fleasion configs folder is:
...
* Make sure the JSON is inside the correct `configs` folder.
